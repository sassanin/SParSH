# ===================================================================
# This is FindBLAS.cmake file for the SParSH Version 1.0
# written by Sashikumaar Ganesan, CDS, IISc Bangalore, India
# date: 16 Mar 2020
# searching for AMD BLAS lib in the system 
...
if(NOT BLAS_FOUND)
  ...
  find_path(BLAS_INCLUDE_DIR  blis.h PATHS ${CMAKE_INCLUDE_PATH})
  
  if(NOT BLAS_INCLUDE_DIR)
    find_path(BLAS_INCLUDE_DIR   mkl.fi PATHS ${CMAKE_INCLUDE_PATH})
  endif(NOT BLAS_INCLUDE_DIR)

  find_library(BLAS_LIBRARY NAMES  blis PATHS ${CMAKE_LIBRARY_PATH})
  get_filename_component(BLAS_LIBDIR ${BLAS_LIBRARY} PATH)
  find_library(BLAS_LIBRARY_MP NAMES blis-mt PATHS ${BLAS_LIBDIR})
  find_library(BLAS_LIBRARY_SQ NAMES blis PATHS ${BLAS_LIBDIR})
